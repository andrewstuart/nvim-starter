...
vim.api.nvim_set_keymap("n", "<leader>r", "<cmd>GoRun<CR>", {noremap = true, silent = true})
vim.api.nvim_set_keymap("n", "<leader>b", "<cmd>GoBuild<CR>", {noremap = true, silent = true})
vim.api.nvim_set_keymap("n", "<leader>t", "<cmd>GoTest<CR>", {noremap = true, silent = true})
vim.api.nvim_set_keymap("n", "<leader>tf", "<cmd>GoTestFunc<CR>", {noremap = true, silent = true})
vim.api.nvim_set_keymap("n", "<leader>gc", "<cmd>GoCoverage<CR>", {noremap = true, silent = true})
